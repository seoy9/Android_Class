...
//        foodList.add(new Food("오코노미야키", "일본"));
    ...
    public void onClick(View v) {
        final ConstraintLayout newfoodLayout = (ConstraintLayout) View.inflate(this, R.layout.newfood_layout, null);
        ...
        switch (v.getId()) {
            case R.id.button:
                ...
                builder.setTitle("음식 추가")
                        .setView(newfoodLayout)
                        .setCancelable(false)
                        .setNegativeButton("취소", null)
                        .setPositiveButton("추가", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                //다이얼로그 레이아웃에 있는 et를 가져와서 물자열을 읽어옴
                                EditText etfood = newfoodLayout.findViewById(R.id.etFood);
                                EditText etnation = newfoodLayout.findViewById(R.id.etNation);
