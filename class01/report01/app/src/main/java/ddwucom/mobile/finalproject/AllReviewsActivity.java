	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        lvContacts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            	...
            	Toast.makeText(AllReviewsActivity.this, "ID : " + id, Toast.LENGTH_SHORT).show();
	...
	public void onMenuItemClick(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.menu_old:
				...
				Toast.makeText(this, "작성순", Toast.LENGTH_SHORT).show();
				break;
			case R.id.menu_top:
				item.setChecked(true);
				...
				Toast.makeText(this, "평점 높은순", Toast.LENGTH_SHORT).show();
				break;
			case R.id.menu_low:
				item.setChecked(true);
				...
				Toast.makeText(this, "평점 낮은순", Toast.LENGTH_SHORT).show();
				break;
			case R.id.menu_location:
				item.setChecked(true);

				Toast.makeText(this, "위치순", Toast.LENGTH_SHORT).show();
				break;
