        ...
        switch (v.getId()) {
            case R.id.btnNoti:
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(this, getString(R.string.CHANNEL_ID))
                        ...
                        .setContentText("기본적인 알림의 메시지보다 더 많은 양의 내용을 알림에 표시하고자 할 때 메세지가 잘리지 않도록 함")
                        .setStyle(new NotificationCompat.BigTextStyle().bigText("기본적인 알림의 메시지보다 더 많은 양의 내용을 알림에 표시하고자 할 때 메세지가 잘리지 않도록 함"))
